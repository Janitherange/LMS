        ...
        <div class="login-content">
            ...
            <div class="login-form">
                <form method="post" action="">
                    ...
                    <input type="submit" value="Sign In" name="submit1" class="btn btn-success btn-flat m-b-30 m-t-30">
                    <div class="social-login-content">
                        <div class="social-button">
                            ...
                            if(isset($_POST["submit1"]))
                            {
                                ...
                                $count=0;
                                $res=mysqli_query($link,"select * from member_registration where username='$_POST[username]' and password='$_POST[password]' and status='yes'");
